...
const MainHomePage = () => {
  ...
  /* 모달 스타일 */
  const customStyles = {
    overlay: {  top:0, left:0, right:0, bottom:0, position:'fixed', backgroundColor:'rgba(0,0,0,0.6)', zIndex:10 },
...
const ModalClick = styled.button`
  width:150px; border:none; border-radius:5px; padding:5px 10px; background-color:black; color:white; font-weight:bold; cursor:pointer;
`
const ModalContainer= styled.div`
  display:flex; flex-direction:column; justify-content:center; align-items:center; padding:0px 30px 40px 40px;
`
const ModalContent = styled.div`
  display:flex; flex-direction:column; justify-content:center; align-items:flex-start; margin:10px 0px
`
const ButtonAlignBox = styled.div`
  display:flex; flex-direction:row;
`
const GroupButton = styled.button`
  width:150px; border:none; border-radius:5px; padding:10px 20px; background-color:black; margin:5px; color:white; font-weight:bold; cursor:pointer;
`
const ModalClose = styled.button`
  width:150px; border:none; border-radius:5px; padding:10px 20px; background-color:gray; margin:5px; color:white; font-weight:bold; cursor:pointer;
`
