    ...
    return(
        <div>
            ...
            <WorkingContainer>
                ...
                <ButtonsContainer>
                    <WorkingButton onClick={uploadButton}>작업 완료</WorkingButton>
                    <WorkingCloseButton onClick={closeButton}>닫기</WorkingCloseButton>
                </ButtonsContainer>
            </WorkingContainer>
        </div>
    )
...
const LogContainer = styled.div`
    width:90%; padding:5px; display:flex; justify-content:flex-end; align-items:center; margin:0 auto;
`
const WorkingContainer = styled.div`
    border:4px dashed black; width:90%; padding:5px; height:100%; display:flex; justify-content:center; align-items:center; margin:0 auto; flex-direction:column;
`
